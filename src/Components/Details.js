...
function Details() {
  ...
  return (
    <div>
      ...
      <Modal isOpen={itemModal} style={customStyles}>
        <div>
          <div
            style={{ float: "right" }}
          ...
          <div>
            ...
            <button
              ...
              onClick={() => {
                subTotal > 0 ? setFormModal(true) : alert("Select some Items");
              }}
            >
              {" "}
              Pay{" "}
                ...
                return (
                  ...
                  >
                    <div className="card">
                      ...
                      >
                        <div
                          className="col-xs-9 col-sm-9 col-md-9 col-lg-9 items "
      ...
      <Modal isOpen={imageModal} style={customStyles2}>
        <div>
          <div
            style={{
              float: "right",
