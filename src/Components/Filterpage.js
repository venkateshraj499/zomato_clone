  ...
  return (
    <div>
      <div className="body">
        ...
        <div
          onClick={() =>
            collapseOpen ? setCollapse(false) : setCollapse(true)
          }
        ...
        >
          FILTERS / SORT
          {collapseOpen ? (
            <i style={{ marginLeft: "15%" }} class="fas fa-angle-up"></i>
          ) : (
            <i style={{ marginLeft: "15%" }} class="fas fa-angle-down"></i>
          )}
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="item_bottom">
                    ...
                    <div className="ans">
                      <div>
                        {restaurant.cuisine.map((Eachcuisine) => {
